...
def train_MIS(D, gnn_depth, dense_depth, dataset_name,batch_size, dim_datasamples, dim_dataset, root_graphs_per_iter,
    ...
    # Changed from 300 to 68 due to smaller graph numbers; 68 matches 300 epochs used in paper
    epochs_roll_out = int(68*root_graphs_per_iter/(idx1-idx0))
...
parser.add_argument('--dataset_name', choices=["TWITTER_SNAP", "COLLAB", "SPECIAL", "RB", "FACEBOOK"], type=str, required=False)
